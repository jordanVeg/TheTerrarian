...
public class TheTerrarianMod implements
    ...
    private static final String resourcesFolder = "TheTerrarianMod";
    ...
    private static final Color cardColor = new Color(10f/255f, 189f/255f, 226f/255f, 1f);
    ...
    public static void initialize() {
        ...
        /* Initialize new card color */
        BaseMod.addColor(TheTerrarian.Enums.CARD_COLOR, cardColor, BG_ATTACK, BG_SKILL, BG_POWER, ENERGY_ORB, BG_ATTACK_P, BG_SKILL_P, BG_POWER_P, ENERGY_ORB_P, SMALL_ORB);
    }

    public TheTerrarianMod() {
    ...
    private static void loadModInfo() {
        Optional<ModInfo> infos = Arrays.stream(Loader.MODINFOS).filter((modInfo)->{
            ...
            return initializers.contains(TheTerrarianMod.class.getName());
        }).findFirst();
        if (infos.isPresent()) {
            info = infos.get();
            modID = info.ID;
