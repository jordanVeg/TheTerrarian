package TheTerrarianMod.character;
...
public class TheTerrarian extends CustomPlayer {
    //Stats
    ...
    //Strings
    private static final String ID = makeID("Terrarian"); //This should match whatever you have in the CharacterStrings.json file
    ...
    public static class Enums {
        ...
        @SpireEnum
        public static AbstractPlayer.PlayerClass THE_TERRARIAN;
        @SpireEnum(name = "TERRARIAN_COLOR") // These two MUST match. Change it to something unique for your character.
        public static AbstractCard.CardColor CARD_COLOR;
        @SpireEnum(name = "TERRARIAN_COLOR") @SuppressWarnings("unused")
        public static CardLibrary.LibraryType LIBRARY_COLOR;
    }

    public TheTerrarian() {
        super(NAMES[0], Enums.THE_TERRARIAN,
